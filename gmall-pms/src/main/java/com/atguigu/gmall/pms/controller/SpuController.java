...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySupByCidAndPage(@PathVariable("categoryId") Long cid , PageParamVo pageParamVo){
        PageResultVo pageResultVo = this.spuService.querySupByCidAndPage(cid , pageParamVo);
